...
if __name__ == '__main__':
    ...
    site_down = os.getenv('site_down') == 'true' if os.getenv('site_down') else True
    GetSrc(username=username, token=token, url=url, repo=repo, mirror=mirror, num=num, site_down=site_down).run()
